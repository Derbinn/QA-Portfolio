...
test cases, detecting defects, and optimizing test processes.

## Skills & Tools

- **Programming**: HTML, CSS, Typescript, React
- **Databases**: MySQL
- **Automation**: Playwright, Katalon, WebdriverIO 
- **Mobile**: Appium
- **API**: Postman
...
- **AI**: Generative AI
- **Tracking/Test Planning**: Jira, Confluence
...
- **Moscow Power Engineering Institute**, Moscow, Russia – B.Sc. in Electrical Engineering
